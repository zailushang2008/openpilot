...
def plannerd_thread():
  ...
  pm = messaging.PubMaster(['longitudinalPlan', 'uiPlan', 'longitudinalPlanExt'])
  sm = messaging.SubMaster(['carControl', 'carState', 'controlsState', 'radarState', 'modelV2', 'navInstruction'],
